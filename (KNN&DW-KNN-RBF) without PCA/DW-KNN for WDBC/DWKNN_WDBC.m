...
function [avg,std1,maximum,minimum,avg_MCC,avg_F1,avg_sensivity,avg_specifity,time,accuracy]= DWKNN_WDBC(image,K)
% Z:khoruji
...
[a,b]= size(Z_Test);
[correct,TP,FP,TN,FN]=correct_DWKNN_WDBC(Z_Test,Z_Train,index1,a,K,weight);
...
for i=1:8
    ...
    [a,b]= size(Z_Test);
    [correct,TP,FN,FP,TN]=correct_DWKNN_WDBC(Z_Test,Z_Train,indexn,a,K,weight);
...
[a,b]= size(Z_Test);
[correct,TP,FN,FP,TN]=correct_DWKNN_WDBC(Z_Test,Z_Train,index10,a,K,weight);
